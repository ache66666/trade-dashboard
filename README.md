...
Staging 测试数据使用受保护命令初始化，必须同时设置 `APP_ENV=staging`、`STAGING_SEED_CONFIRM=staging`，并用 `STAGING_DATABASE_PROJECT_REF` 校验连接目标，详见 [数据库设计](docs/11-DATABASE.md#staging-seed)。Production 环境会在连接数据库前拒绝执行。
...
- [Engineering Foundation v1](docs/ENGINEERING_FOUNDATION.md)
- [PR Checklist](docs/CHECKLIST.md)
- [Deployment Checklist](docs/DEPLOY_CHECKLIST.md)
- [Debug Guide](docs/DEBUG_GUIDE.md)
- [Architecture Decision Records v1](docs/adr/)
